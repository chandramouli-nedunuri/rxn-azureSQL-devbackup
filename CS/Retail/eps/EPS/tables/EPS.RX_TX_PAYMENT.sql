-- =====================================================================
-- CONVERTED: EPS.RX_TX_PAYMENT
-- =====================================================================
-- Source: Oracle EPS
-- Target: Azure SQL Server 2019+
-- Conversion Date: May 29, 2026
-- Status: BATCH 13, File 118

-- Master table for prescription transaction payments
...
IF OBJECT_ID('[EPS].[RX_TX_PAYMENT]', 'U') IS NOT NULL
    DROP TABLE [EPS].[RX_TX_PAYMENT]
GO
