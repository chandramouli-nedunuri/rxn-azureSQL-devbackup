...
-- Source: EPR_Oracle/Views/EPS.VW_SCHEMA_UPDATER_MANIFEST(1).sql
...
-- Changed: NULLS LAST -> ORDER BY ... DESC handling via CASE statement

CREATE VIEW [EPS].[VW_SCHEMA_UPDATER_MANIFEST] ([VERSION], [FILE_NAME], [APPLY_ORDER]) AS 
SELECT 
    [version],
    [file_name],
