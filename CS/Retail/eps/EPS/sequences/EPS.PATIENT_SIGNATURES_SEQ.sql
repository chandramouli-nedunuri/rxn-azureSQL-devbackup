...
CREATE SEQUENCE EPS.PATIENT_SIGNATURES_SEQ
    AS BIGINT
    START WITH 1001
    INCREMENT BY 1
    MINVALUE 1
...
-- Conversion Notes:
-- 1. Converted double-quoted identifiers to unquoted standard syntax: "EPS"."PATIENT_SIGNATURES_SEQ" → EPS.PATIENT_SIGNATURES_SEQ
...
-- 5. Kept CACHE 500 as specified in original Oracle definition
