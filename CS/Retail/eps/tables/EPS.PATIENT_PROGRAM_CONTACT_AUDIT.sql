-- ============================================================================
-- Azure SQL Conversion: EPS.PATIENT_PROGRAM_CONTACT_AUDIT
...
(
    ...
    CONSTRAINT [PATIENT_PROGRAM_CONTACT_AUDIT_PK] PRIMARY KEY CLUSTERED ([CHAIN_ID], [ID]) WITH (FILLFACTOR = 90),
    CONSTRAINT [PATIENT_PROGRAM_CONTACT_AUDIT_FK1] FOREIGN KEY ([CHAIN_ID], [ID_PATIENT]) 
...
-- Paired Audit: This is the standard audit table; see PATIENT_PROGRAM_CONTACT_AUDIT_CSD_23800 for CSD variant
