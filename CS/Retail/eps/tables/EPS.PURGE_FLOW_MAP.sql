-- =====================================================================
-- CONVERTED: EPS.PURGE_FLOW_MAP
-- =====================================================================
-- Source: Oracle EPS
-- Target: Azure SQL Server 2019+
-- Conversion Date: May 29, 2026
-- Status: BATCH 12, File 102

-- Utility table for purge flow mapping
...
IF OBJECT_ID('[EPS].[PURGE_FLOW_MAP]', 'U') IS NOT NULL
    DROP TABLE [EPS].[PURGE_FLOW_MAP]
GO
...
CREATE TABLE [EPS].[PURGE_FLOW_MAP] (
    ...
    CONSTRAINT [PURGE_FLOW_MAP_PK] PRIMARY KEY CLUSTERED ([CHAIN_ID], [FLOW_ID])
)
GO
...
CREATE NONCLUSTERED INDEX [IX_PURGE_FLOW_MAP_CHAIN]
ON [EPS].[PURGE_FLOW_MAP] ([CHAIN_ID])
GO
